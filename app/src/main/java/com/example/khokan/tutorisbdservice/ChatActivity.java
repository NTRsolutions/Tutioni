...
public class ChatActivity extends AppCompatActivity {
    ...
    private String messageReciverID, messageReciverName,messageReciverImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(messageReciverImage).placeholder(R.drawable.profile_image).into(userProfileImage);
    ...
    private void initializeControllers() {
        ...
        chatToolbar = findViewById(R.id.groups_chat_appbar);
    ...
    private void sendMessage() {
            ...
            {
                Toast.makeText(this, "Please Type your Messages.....", Toast.LENGTH_SHORT).show();
            }
            else
            {
                    ...
                    DatabaseReference userMessageKeyRef = rootRef.child("Messages")
                            .child("messagesSenderID").child("messageReceiverID").push();
