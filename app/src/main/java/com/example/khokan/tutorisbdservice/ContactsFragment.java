                ...
                usersRef.child(userIDs).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.hasChild("image"))
                        {
                            ...
                            String profilePrivateTutor = dataSnapshot.child("private_tutors").getValue().toString();
                            String profileProfession = dataSnapshot.child("profession").getValue().toString();

                            holder.userName.setText(profileName);
                            holder.userStatus.setText(profileProfession);
                            holder.private_tutor.setText("Private Tutor: "+profilePrivateTutor);
